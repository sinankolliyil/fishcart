...
export function CategoryCard({
  ...
  return (
    <Link
      href={href}
      className={cn(
        'group relative flex flex-col justify-between overflow-hidden rounded-2xl p-6 shadow-sm transition-transform hover:-translate-y-1',
        currentStyle.bg,
        className
      )}
    >
      ...
      <div className="absolute right-4 bottom-4 z-10">
        <div
          className={cn(
            'flex h-[32px] w-[32px] items-center justify-center rounded-full bg-white shadow-sm transition-transform group-hover:scale-110',
            currentStyle.arrow
          )}
        >
